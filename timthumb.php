...
/*
    ...
    Usage: <img src="<?php bloginfo('template_directory') ?>/timthumb.php?src=<?php echo $url ?>&w=CUSTOM-WIDTH&h=CUSTOM-HEIGHT&zc=1" />
*/
...
define ('CACHE_CLEAR', 6);        // maximum number of files to delete on each cache clear
